...
namespace Thing.Designer.Infrastructure.Local.Data;
...
public static class IdentityHelpers
{
    ...
    private static Task SetIdentityInsert<T>(DbContext context, bool enable)
    {
        ...
        if (entityType is null)
            throw new NullReferenceException("Entity type not found");
    ...
    {
        return context.Database.ProviderName?.Contains("SqlServer") ?? false;
    }
}
